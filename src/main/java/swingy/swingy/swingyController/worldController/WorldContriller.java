package swingy.swingy.swingyController.worldController;

import swingy.swingy.swingyView.swingyViewConsole.ConsoleView;
import swingy.swingy.swingyView.swingyViewGui.*;
import swingy.swingy.swingyController.heroController.HeroController;
import swingy.swingy.swingyModel.swingyDatabase.DatabaseSetup;
...
public class WorldContriller extends Application{
	...
	public static void tmpMain(String[] args) {
		...
		for (String s: args) {
			if (s.trim().equals("console")){
				console.worldView();
			}else if (s.trim().equals("gui"))
				launch(args);
			else{
